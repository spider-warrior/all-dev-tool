...
import cn.t.tool.netproxytool.http.server.handler.FetchMessageHandlerHttps;
 ...
 **/
public class HttpsProxyClientChannelInitializerBuilder extends NettyChannelInitializerBuilder {
    public HttpsProxyClientChannelInitializerBuilder(ChannelHandlerContext remoteChannelHandlerContext, ProxyBuildResultListener proxyBuildResultListener) {
        ...
        addChannelHandlerSupplier(() -> new FetchMessageHandlerHttps(remoteChannelHandlerContext, proxyBuildResultListener));
    }
}
