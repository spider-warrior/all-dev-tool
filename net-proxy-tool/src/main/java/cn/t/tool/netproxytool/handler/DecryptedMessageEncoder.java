 ...
 **/
public class DecryptedMessageEncoder extends MessageToByteEncoder<ByteBuf> {
    ...
    public DecryptedMessageEncoder(byte[] keyBytes) throws NoSuchPaddingException, NoSuchAlgorithmException {
