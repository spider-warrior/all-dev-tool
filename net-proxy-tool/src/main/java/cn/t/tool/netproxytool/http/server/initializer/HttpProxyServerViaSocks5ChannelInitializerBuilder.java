...
public class HttpProxyServerViaSocks5ChannelInitializerBuilder extends NettyChannelInitializerBuilder {
    public HttpProxyServerViaSocks5ChannelInitializerBuilder(Socks5ClientConfig socks5ClientConfig) {
        ...
        addChannelHandlerSupplier(() -> new HttpProxyServerViaSocks5Handler(socks5ClientConfig));
    }
}
